...
2.0 Features
    ...
    Mainscreen cloned items cache with materials and textures.
    Water Resistance.
    Slow Reload!
    Visuals Modifier by Rexabit!
    Add base hp/stam/eitr to SEs.
...
### Installation
    ...
    Inside the "wackysDatabase" folder, you will find subfolders: 
...
Frequently Asked Questions
    ...
    Q: Is it possible to add a recipe for each upgrade of an item?
        A: Yes! You can add custom recipes for each upgrade level of an item.
...
- `wackydb_sendtheload` : Sends missing pngs/objs/textures to clients utilizing ServerSync. This now auto-triggers for players when they log in; this command is still useful as a manual re-send if needed.
