...
namespace wackydatabase.Startup
{
    ...
    static class ZrouteMethodsAdminReloadPushOnServer
    {
        internal static void Prefix()
        {
            ...
            ZRoutedRpc.instance.Register("WackyDB_ClientMSG", new Action<long, string>(HandleData.ClientMSG));
            ZRoutedRpc.instance.Register("WackyDB_AdminLogMsg", new Action<long, string>(HandleData.AdminLogMsg));
