| Version | Changes                                                                                                                                                                                                                                                                                                                                |
|----------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.4.4   | Add support for multiple Piece CSExtensionData. You can now also make (almost) any piece into an extension for a craftingstation. </br> Added support for Pieces to become craftingstations. </br> Added Pickable m_extraDrops stuff </br> Removed unnecessary warning for disabled pieces.
