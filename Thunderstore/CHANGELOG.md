| Version | Changes                                                                                                                                                                                                                                                                                                                                |
|----------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.4.84  | Rewrote a lot of the logic for live updates. </br> Improved piece snapshot handling. </br> Send the Load now triggers after a player logs in. No need to include the textures anymore.|
