| Version | Changes                                                                                                                                                                                                                                                                                                                                |
|----------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 2.4.73  | Bug Fix for some Materials. </br> Rewrote the piece moving category logic a bit to reduce bugs. </br> Worked on wackydb_sendtheload a bit, should now handle texture sending and alert the admin when done.
