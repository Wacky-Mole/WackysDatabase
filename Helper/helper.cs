...
namespace wackydatabase.Helper
{
    internal class helper
    {
        ...
        internal static List<GameObject> GetPieces(ObjectDB Instant)
        {
        ...
        internal static GameObject GetModdedPieces(string name)
        {
        ...
        internal static GameObject FindPieceObjectName(string name)
        {
        ...
        internal static void GetPieceStations()
        {
            MaybePieceStations = Resources.FindObjectsOfTypeAll<PieceTable>(); // so easy
        }
        internal static void GetPiecesatStart()
        {
